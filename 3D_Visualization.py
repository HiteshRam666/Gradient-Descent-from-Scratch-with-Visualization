...
for _ in range(1000):
    X_derivative, Y_derivative = caluclate_gradient(current_pos[0], current_pos[1])
    ...
    X_derivative, Y_derivative = caluclate_gradient(current_pos2[0], current_pos2[1])
    ...
    X_derivative, Y_derivative = caluclate_gradient(current_pos3[0], current_pos3[1])
